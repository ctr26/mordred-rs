...
**Descriptors implemented (9):**
- Constitutional: `nAtom`, `nHeavyAtom`, `nBond`, `MW`
- Topological: `WienerIndex`, `Zagreb1`, `Zagreb2`
- Connectivity: `Chi0`, `Chi1`
...
| RingCount | nRing, nRing3-12, nHeteroRing | TODO |
| AtomCount | nC, nN, nO, nS, nP, nHalo, nHetero | TODO |
| BondCount | nSingle, nDouble, nTriple, nAromatic | TODO |
...
- [ ] SSSR algorithm (smallest set of smallest rings)
- [ ] Atom typing system (for LogP, EState)
- [ ] Hybridization detection from bond orders
...
| Benchmarks | criterion.rs vs Python mordred |
| SDF parser | [#61](https://github.com/mordred-descriptor/mordred/issues/61) — PubChem SDF hardening |
| Rayon | Parallel batch calculation |
| PyPI | maturin publish |
| crates.io | cargo publish |
| Docs | [#8](https://github.com/mordred-descriptor/mordred/issues/8) — numerical examples |
